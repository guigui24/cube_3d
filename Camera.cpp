...
void Camera::orienter(int xRel, int yRel)
{
    ...
    if(m_axeVertical.x == 1.0)
    {
        ...
        m_orientation.x = 100*sin(phiRadian);
        m_orientation.y = 100*cos(phiRadian) * cos(thetaRadian);
        m_orientation.z = 100*cos(phiRadian) * sin(thetaRadian);
    }
    ...
    else if(m_axeVertical.y == 1.0)
    {
        ...
        m_orientation.x = 1*cos(phiRadian) * sin(thetaRadian);
        m_orientation.y = 1*sin(phiRadian);
       // m_orientation.y = 0;
        m_orientation.z = 1*cos(phiRadian) * cos(thetaRadian);
    }
    ...
    else
    {
        ...
        m_orientation.x = 100*cos(phiRadian) * cos(thetaRadian);
        m_orientation.y = 100*cos(phiRadian) * sin(thetaRadian);
        m_orientation.z = 100*sin(phiRadian);
    }
